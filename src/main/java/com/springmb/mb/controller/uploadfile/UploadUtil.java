...
import com.springmb.mb.util.SystemUtils;
...
public class UploadUtil {
	...
	public static String saveFile(MultipartFile file, String flieTypeFolder) {
		...
		String doMain="";
//		doMain = getDoMain();
		String httpUrl =doMain+uploadConfig.http_prefix + flieTypeFolder + currDateFolder + "/" + fileName;	// 对外暴露的http路径
	...
	static String getDoMain() {
		return SystemUtils.config.getDomain();
	}
