   			...
   			table.render({
   				...
   				cols: [
                        [{fixed:'left', type: 'checkbox', width: 30}
                            ...
                            , {field: '', title: '登录天数', width: 120, align: 'center'}
                            , {field: '', title: '奖励钻石', width: 120, align: 'center'}                         
   					...
   					$(".layui-table-main  tr").each(function(index, val) {
   						...
   						table.on('toolbar(award)', function(obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
