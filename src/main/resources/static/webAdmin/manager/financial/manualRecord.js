   			...
   			table.render({
   				...
   				cols: [
                        [{fixed:'left', type: 'checkbox', width: 30}
                            ...
                            , {field: '', title: '会员 (账号)(ID)', width: 120, align: 'center'}                         
                            , {field: '', title: '充值点数', width: 120, align: 'center'},
   					...
   					$(".layui-table-main  tr").each(function(index, val) {
   						...
   						table.on('toolbar(manual)', function(obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
