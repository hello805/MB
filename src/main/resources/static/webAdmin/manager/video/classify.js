   			...
   			table.render({
   				...
   				cols: [
                        [{fixed:'left', type: 'checkbox', width: 30},
						 , {field: '', title: '序号', width: 120, align: 'center'}
                            , {field: 'id', title: 'ID', width: 80, align: 'center'}
                            , {field: '', title: '分类名称', width: 120, align: 'center'}
                            , {field: '', title: '分类图标', width: 120, align: 'center'}                         
   					...
   					$(".layui-table-main  tr").each(function(index, val) {
   						...
   						table.on('toolbar(classify)', function(obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
