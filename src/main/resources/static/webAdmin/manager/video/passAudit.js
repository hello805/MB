   			...
   			table.render({
   				...
   				cols: [
                        [{fixed:'left', type: 'checkbox', width: 30}
                            ...
                            , {field: '', title: '会员昵称（ID）', width: 120, align: 'center'}
                            , {field: '', title: '标题', width: 120, align: 'center'}                         
                            , {field: '', title: '图片', width: 120, align: 'center'} 
							 , {field: '', title: '点赞数', width: 120, align: 'center'} 
							  , {field: '', title: '评论数', width: 120, align: 'center'} 
							   , {field: '', title: '分享数', width: 120, align: 'center'} 
							    , {field: '', title: '视频状态', width: 120, align: 'center'} 
								, {field: '', title: '上下架状态', width: 120, align: 'center'} 
