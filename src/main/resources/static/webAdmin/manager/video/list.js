   			...
   			table.render({
   				...
   				cols: [
                        [{fixed:'left', type: 'checkbox', width: 30}
                            ...
                            , {field: '', title: '音乐名称', width: 120, align: 'center'}
                            , {field: '', title: '演唱者', width: 120, align: 'center'}                         
                            , {field: '', title: '上传类型', width: 120, align: 'center'} 
							 , {field: '', title: '上传者', width: 120, align: 'center'} 
							  , {field: '', title: '封面', width: 120, align: 'center'} 
							   , {field: '', title: '音乐长度', width: 120, align: 'center'} 
							    , {field: '', title: '音乐地址', width: 120, align: 'center'} 
								, {field: '', title: '使用次数', width: 120, align: 'center'} 
								 , {field: '', title: '是否删除', width: 120, align: 'center'} 
								  , {field: '', title: '所属分类', width: 120, align: 'center'} 
								  , {field: '', title: '是否删除', width: 120, align: 'center'} 
								   , {field: '', title: '添加时间', width: 120, align: 'center'} 
								   , {field: '', title: '修改时间', width: 120, align: 'center'} 
