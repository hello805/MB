   ...
   form.render('select');
   			table.render({
   				...
   				cols: [
                        ...
                        , {field: 'id', title: '排序', width: 80, align: 'center'}
                           , {field: 'id', title: 'ID', width: 80, align: 'center'}
                           , {field: '', title: '靓号', width: 120, align: 'center'}
                           , {field: '', title: '所需点数', width: 120, align: 'center'}                         
                           , {field: '', title: '位数', width: 120, align: 'center'} 
						   , {field: 'id', title: '状态', width: 80, align: 'center'}
						   , {field: '', title: '发布时间', width: 120, align: 'center'}
						   , {field: '', title: '购买人', width: 120, align: 'center'}                         
						   , {field: '', title: '购买时间', width: 120, align: 'center'} 
   					...
   					$(".layui-table-main  tr").each(function(index, val) {
   						...
   						table.on('toolbar(user)', function(obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
