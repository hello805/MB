   			...
   			table.render({
   				...
   				cols: [
                        [{fixed:'left', type: 'checkbox', width: 30},
                            ...
                            , {field: '', title: '举报人', width: 120, align: 'center'}
                            , {field: '', title: '被举报人', width: 120, align: 'center'} ,
							
							, {field: '', title: '被举报人视频Id', width: 120, align: 'center'}
							, {field: '', title: '举报内容', width: 120, align: 'center'}
							 , {field: 'id', title: '状态', width: 80, align: 'center'}
							 , {field: '', title: '提交时间', width: 120, align: 'center'}
							  , {field: 'id', title: '处理时间', width: 80, align: 'center'}
   					...
   					$(".layui-table-main  tr").each(function(index, val) {
   						...
   						table.on('toolbar(type)', function(obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
