   			...
   			table.render({
   				...
   				cols: [
                        [{fixed:'left', type: 'checkbox', width: 30}
                            ...
                            , {field: '', title: '会员ID', width: 120, align: 'center'}                         
                            , {field: '', title: '直播Id', width: 120, align: 'center'},
							, {field: '', title: '流名', width: 120, align: 'center'}
							, {field: '', title: '直播收益', width: 120, align: 'center'}                         
							, {field: '', title: '直播开始时间', width: 120, align: 'center'},
							, {field: '', title: '直播结束时间', width: 120, align: 'center'},
							, {field: '', title: '总人数', width: 120, align: 'center'}
