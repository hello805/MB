...
, {field: '', title: '链接', width: 120, align: 'center'}
, {field: 'id', title: '图片', width: 80, align: 'center'}
...
table.on('toolbar(upd)', function(obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
