...
, {field: '', title: '应用', width: 120, align: 'center'}
, {field: '', title: '菜单名称', width: 120, align: 'center'}
...
table.on('toolbar(menu)', function(obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
