   				...
   				cols: [
                       [{fixed:'left', type: 'checkbox', width: 30},
                        , {field: 'id', title: '编号', width: 80, align: 'center'}
                           , {field: 'id', title: '发送者（ID）', width: 80, align: 'center'}
                           , {field: '', title: '红包类型', width: 120, align: 'center'}
                           , {field: '', title: '发放类型', width: 120, align: 'center'}                         
                           , {field: '', title: '已抢/总金额', width: 120, align: 'center'} 
							 , {field: '', title: '已抢/总个数', width: 120, align: 'center'}                         
							 , {field: '', title: '描述', width: 120, align: 'center'} 
							 , {field: '', title: '生效时间', width: 120, align: 'center'}                         
